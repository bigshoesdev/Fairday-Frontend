...
//             <img src="http://localhost:5173/src/assets/images/user1.png" className='pl-5 pr-4 cursor-pointer' onClick={() => navigate('/user/userprofile')} />
//             <p className='text-white mb-0 px-1 cursor-pointer'>
//               {user?.name}
//             </p>
//           </>
