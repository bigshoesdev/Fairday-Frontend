...
const SpecialJobDetail = ({ jobDeatil, jobConstManage }: any) => {
  return (
    <div className="w-full max-w-[1200px] mx-auto bg-white p-5 px-10 rounded-lg mt-5 mb-10 shadow-lg overflow-hidden px-2">
      <div className="p-10">
        <p className="text-[30px] font-semibold">Special Job Details</p>
        <p className="text-[18] mb-1 text-gray-500">
        ...
        <div>
          ...
          <p className="text-[18] mt-4 font-bold">
            usename <span className="text-gray-400 font-thin">2 min ago</span>
          </p>
          <p className="text-[18] mt-4 text-gray-400 font-thin">
        ...
        <Button
          text="APPLY NOW"
          className="hidden bg-darkBlue items-center mt-5 float-right py-2 border-darkBlue hover:border-blue-400 border-r border-r-white text-white !font-medium text-[20px] hover:bg-blue-400 transition-all cursor-pointer focus:outline-none"
          onClick={() => console.log()}
        />
      </div>
