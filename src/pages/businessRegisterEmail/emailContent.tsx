...
const EmailContent = () => {
  return (
    <div className="bg-white rounded-lg p-6 max-w-[950px] flex  items-center flex-col">
      ...
      <span className="text-primaryBlue title">BHP # 1254351</span>
      <span className="font-bold text-black">VIEW / EDIT PROFILE</span>

      <p className="text-center text-contentText mt-5">
        Keep this number safe to use in applying for the good jobs listed in <span className="text-primaryBlue">fairdayjobs.com</span>, lorem in volupate velit esse cilum dolore eu fugiat nulia pariatur.
