const HeaderBanner = () => {
  return (
    <div className='w-screen bg-darkTealGray flex flex-col justify-center items-center bg-[url("https://fairdayjobs.com/src/assets/images/footer-banner.png")] bg-cover h-[400px]'>
