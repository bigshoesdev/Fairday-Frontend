    ...
    return (
        <div className='flex flex-col p-5 bg-white border border-white hover:border-blue-400 rounded-[10px] shadow-lg gap-4'>
            ...
            <div className='flex justify-between gap-5'>
                ...
                <div className='flex flex-col text-[14px]'>
                    <span>Seniority Level: <span>{jobSeniority}</span></span>
                    <span>Industry: <span>{jobIndustry}</span></span>
                    <span>Employment Type: <span>{jobType}</span></span>
                </div>
                <div className='flex flex-col gap-2 text-[13px]'>
                    <button className='px-[18px] bg-white text-gray-500 hover:text-white border-gray-300 rounded-[0px] hover:bg-primaryBlue focus:outline-none flex justify-between items-center w-28'>
                        <span>SAVE</span>
