...
const Content = ({ hideEmployerConfirm, setHideEmployerConfirm, agreeConfirm, setAgreeConfirm, autoSaveContrim, setAutoSaveContrim }) => {
    ...
    return (
        <div className="flex flex-col p-10 bg-white shadow-xl rounded-xl max-w-[950px]">
            ...
            <span className="font-semibold">OVERALL RATINGS</span>
