...
const BusinessDetail = ({ businessProfileData, isHideEdit }) => {
    ...
    return (
        <div className='bg-[#FAFAFA] flex-col sm:flex-row  w-full py-3 rounded-b-[10px] flex gap-3'>
            <div className="flex-[5] flex-col">
                <UserDetail item={businessProfileData} userprofile={true} isHideEdit={isHideEdit} link={'/business-applicant-profile-registration'} />
            </div>
            <div className="flex-[7] w-full">
                <div className="w-full flex flex-col gap-3 relative">
                    <div className="flex flex-col bg-white container max-w-[950px] shadow-lg py-4 rounded-xl">
                        <div className="flex justify-between py-5 items-center">
                            ...
                            <Button
                                ...
                                className='hidden bg-blue-500 text-white  px-6 py-2 hover:bg-gray-200 transition-all cursor-pointer hover:border-gray-400 focus:outline-none'
                            />
                        </div>
                        <div >
                        ...
                        <div className='flex flex-row justify-between pt-5 pb-3'>
                            <span className='font-bold text-gray-600 text-[18px] sm:text-[20px]'>Business Address</span>
                            <span className='font-bold text-gray-600 text-[18px] sm:text-[20px]'>Years at this location</span>
                        </div>
                        <div className='flex flex-row justify-between font-semibold text-[14px] sm:text-[16px]'>
                    ...
                    <div className='flex flex-col bg-white container max-w-[950px] shadow-lg py-6 rounded-xl'>
                        <div className='flex flex-row'>
                            <div className='flex flex-col w-full'>
                                ...
                                {
                                    businessProfileData?.businessInsurance == "yes" ?
                                        <Button
                                            text="Yes"
                                            onClick={onClick}
                            ...
                            <div className='flex flex-col w-full'>
                                ...
                                {
                                    businessProfileData?.workmansInsurance == "yes" ?
                                        <Button
                                            text="Yes"
                                            onClick={onClick}
                                            className='mt-3 w-20 bg-blue-500 text-white  px-6 py-2 hover:bg-gray-200 transition-all cursor-pointer hover:border-gray-400 focus:outline-none'
                    ...
                    <div className="w-full flex bg-white shadow-lg rounded-[10px] p-3 px-5 gap-2 max-w-[950px] hidden">
...
"
                    ...
                    <div className='flex flex-col sm:flex-row sm:justify-between w-full max-w-[950px]  gap-8'>
                        <div className='flex flex-col bg-white w-full shadow-lg container py-5 rounded-xl'>
                            ...
                            {
                                businessProfileData?.coupon ?
                                    <p className='mt-2'>Coupon <span className='text-blue-500'>#{businessProfileData?.coupon}</span></p>
                                    : <p className='mt-2'></p>
                            }
                    ...
                    <div className="w-full flex flex-col bg-white shadow-lg rounded-[10px] p-3 px-5 container max-w-[950px] hidden">
