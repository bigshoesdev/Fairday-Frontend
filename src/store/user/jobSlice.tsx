...
export const getCategoryCount = () => async (dispatch: any): Promise<any> => {
  try {
    ...
    const response = await axios.get("https://fairdayjobs.com/api/v1/user/job/get-category-count");
...
export const getJobsByQuery = (data: any) => async (dispatch: any): Promise<any> => {
  try {
    ...
    const response = await axios.post(`https://fairdayjobs.com/api/v1/user/job/get-job-by-query?${data.toString()}`);
...
export const postJob = (data: any) => async (dispatch: any): Promise<any> => {
  try {
    dispatch(configLoading());
    const response = await axios.post("https://fairdayjobs.com/api/v1/user/job/post-job", data);
...
export const getJobCategoryByAlpha = (data: any) => async (dispatch: any): Promise<any> => {
  try {
    dispatch(configLoading());
    const response = await axios.post("https://fairdayjobs.com/api/v1/user/job/get-category-list-by-alpha", data);
...
export const getJobConstManage = () => async (dispatch: any): Promise<any> => {
  try {
    dispatch(configLoading());
    const response = await axios.get("https://fairdayjobs.com/api/v1/user/job/get-const-list");
